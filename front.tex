...
%\end{glossary}
  ...
  % Reference: PU 17.
\begin{abstract}
Physical systems are becoming increasingly
computationally powerful as faster microprocessors are installed. This allows many types of applications
and functionality to be implemented. Much of the security risk has to do with confirming the device as an authentic 
device. This risk can be mitigated achievable using a technology
...
as read once keys, secure communications, and secure smart grids.
\end{abstract}
